...
emittanceXCore = 7.7e-9*0.02
deltaCore = 6.97e-4

emittanceX3IB = 13.8e-9*0.02
...
sigxCoreturn1 = 1.0e3 * np.sqrt(emittanceXCore * np.array(byCoreturn1,dtype=np.float64)) # + m.pow(deltaCore,2) * np.power(etaxCoreturn1, 2))
divxCoreturn1 = 1.0e3 * np.sqrt(emittanceXCore / np.array(byCoreturn1,dtype=np.float64))
...
sigx3IBturn1 = 1.0e3 * np.sqrt(emittanceX3IB * np.array(by3IBturn1,dtype=np.float64)) # + m.pow(delta3IB,2) * np.power(etax3IBturn1, 2))
sigx3IBturn2 = 1.0e3 * np.sqrt(emittanceX3IB * np.array(by3IBturn2,dtype=np.float64)) # + m.pow(delta3IB,2) * np.power(etax3IBturn2, 2))
sigx3IBturn3 = 1.0e3 * np.sqrt(emittanceX3IB * np.array(by3IBturn3,dtype=np.float64)) # + m.pow(delta3IB,2) * np.power(etax3IBturn3, 2))

divx3IBturn1 = 1.0e3 * np.sqrt(emittanceX3IB / np.array(by3IBturn1,dtype=np.float64))
divx3IBturn2 = 1.0e3 * np.sqrt(emittanceX3IB / np.array(by3IBturn2,dtype=np.float64))
divx3IBturn3 = 1.0e3 * np.sqrt(emittanceX3IB / np.array(by3IBturn3,dtype=np.float64))
...
ax1.set_ylabel(r'$\sigma_{y}$ / mm ', size=14)
...
ax2.set_ylabel(r'$\sigma_{y}\,\prime$ / $m rad$ ', size=14)
...
ax2.yaxis.set_minor_locator(ticker.MultipleLocator(0.0005))
...
savefig('res_Twiss_SigSize_YY.png')
